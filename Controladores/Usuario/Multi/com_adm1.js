...
function AgregarCerti(){
    ...
    // Se insertan nuevas celdas 
    var celc1 = newf.insertCell(0); // Nombre Certificado
    var celc2 = newf.insertCell(1); // Organizacion Emisora
    var celc3 = newf.insertCell(2); // Fecha Expedicion        
    var celc4 = newf.insertCell(3);  //Cerificado

   // Agregar input Nombre
    var inputNomC = document.createElement("input");
    inputNomC.type = "text";
    inputNomC.name = "d"+cont2;
    cont2++; // Incrementa después de agregar el input
    inputNomC.minLength = "3";
    inputNomC.required = "required";
    inputNomC.className = "form_multi-i";
    celc1.appendChild(inputNomC);
   ...
   // Agregar input Organizacion
    ...
    celc3.appendChild(inputFec_exp); 
