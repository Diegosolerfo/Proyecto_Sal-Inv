...
<body>
     <div class="navbar navbar-expand-lg navbar-success container">
                ...
                <a href="{{ route('inventario-material.index') }}" class="navbar-brand">Inventario  material</a>
                <a href="{{ route('inventario-herramienta.index') }}" class="navbar-brand">Inventario herramienta</a>
