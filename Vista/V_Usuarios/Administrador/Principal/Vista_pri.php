...
<body>
    ...
    <!-- Presentacion y bienbenida del usuario -->
    <section class="container mt-5">
    <h2>¿Hola Administrador, cómo te encuentras el día de hoy?</h2>
    <h4>
        Por favor, navega por el menú para que puedas gestionar los diferentes 
        módulos: usuarios, inventario, productos, pedidos y ventas.
    </h4>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul class="list-group">
                <li class="list-group-item">Usuarios:
                    <ul>
                        <li>Registrar administradores y operadores</li>
                        <li>Ver los administradores y operadores</li>
                        <li>Eliminar usuarios y más.</li>
                    </ul>
                </li>
                <li class="list-group-item">Inventario:
                    <ul>
                        <li>Herramientas:
                            <ul>
                                <li>Agregar herramientas al inventario</li>
                                <li>Actualizar información de herramientas</li>
                                <li>Eliminar herramientas del inventario</li>
                            </ul>
                        </li>
                        <li>Materiales:
                            <ul>
                                <li>Agregar materiales al inventario</li>
                                <li>Actualizar información de materiales</li>
                                <li>Eliminar materiales del inventario</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li class="list-group-item">Productos:
                    <ul>
